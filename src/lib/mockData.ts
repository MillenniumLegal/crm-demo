...
const AUTOMATIONS = [
  ...
  ['Recovery: Accepted quote → instruction handoff', 'Queue rescue tasks where the client showed instruction intent but has not reached legal handoff', 'custom', 4, true],
...
const RECOVERY_ENGINE = {
  ...
  kpis: [
    ...
    { label: 'Recovered', value: '37', sub: 'instructions saved', tone: 'good', deltaPct: 16, good: true },
  ...
  cohorts: [
    ...
    },
    {
      ...
      reason: 'May still need rescue help if their chosen route stalls before instruction, but keep it low-pressure.',
      eligible: 71,
      value: 18400,
      avgAgeDays: 96,
      aiTouches: 204,
      ...
      trend: [4, 5, 5, 6, 7, 8],
      leads: [
        { leadId: 'lead-h31', lead: 'History Lead 32', agent: 'Dej A', date: '9 Jun', trigger: 'Gone elsewhere 104d ago', outcome: 'no response', aiDraft: 'I hope your move is going smoothly. If anything gets stuck before you instruct, I am happy to point you in the right direction.', nextAction: 'Hold as quarterly helpful check-in.', note: 'Recovery value lower; only revive if there is fresh pre-instruction intent.', value: 840 },
    ...
    {
      key: 'accepted-not-instructed',
      label: 'Accepted not instructed',
      reason: 'Quote accepted or instruction pack started, but the handoff to legal has not completed.',
      eligible: 54,
      value: 29800,
      avgAgeDays: 142,
      aiTouches: 394,
      replyRate: 31,
      conversionRate: 9.1,
      risk: 'handoff-safe only',
      suppression: 3,
      channel: 'email',
      confidence: 86,
      trend: [5, 6, 8, 10, 12, 15],
      leads: [
        { leadId: 'lead-10', lead: 'Sarah Pearse', agent: 'Helen Sadler', date: '15 Jun', trigger: 'Instruction pack opened, not submitted', outcome: 'email opened', aiDraft: 'You are nearly at instruction handoff. Do you want me to resend the pack or help with the missing step?', nextAction: 'Approve handoff reminder.', note: 'High intent; Connor owns this until legal handoff is confirmed.', value: 1300 },
        { leadId: 'lead-11', lead: 'Jasmine Ashford', agent: 'Jonny Green', date: '13 Jun', trigger: 'Deposit intent logged, pack incomplete', outcome: 'reply positive', aiDraft: 'I can see the instruction step is not fully complete yet. Reply here and I will get the right link back to you.', nextAction: 'Create instruction-pack rescue task.', note: 'Client replied positively to check-in.', value: 1180 },
      ],
    },
  ],
  campaigns: [
    ...
    { key: 'handoff-rescue', name: 'Instruction handoff rescue', channel: 'email', status: 'running', sent: 394, opened: 244, replied: 64, recovered: 8, value: 9700, openRate: 62, replyRate: 16, conversionRate: 2.0, cost: 88, spark: [20, 24, 31, 36, 48, 64] },
  ...
  agentQueue: [
    ...
    { agent: 'Jonny Green', freeSlots: 5, tasks: 16, value: 21600, focus: 'Instruction handoff rescue', channels: 'Email + call', expectedRecovery: 6, oldest: '7d' },
  ],
  aiCalls: [
  ...
  scores: [
    ...
    { leadId: 'lead-10', lead: 'Sarah Pearse', score: 84, value: 1300, reason: 'Instruction pack stalled before legal handoff', lastSignal: 'Pack opened today', contactConfidence: 94, risk: 'low', agent: 'Jonny Green', nextBestAction: 'Approve instruction-pack rescue', channel: 'email', badges: ['handoff gap', 'warm open', 'instruction intent'], trend: [60, 64, 70, 78, 80, 84] },
  ...
  lostReasons: [
    ...
    { reason: 'Accepted not instructed', count: 54, value: 29800, replyRate: 31, recoveredRate: 9.1, topAction: 'Instruction pack and handoff rescue', trend: [5, 6, 8, 10, 12, 15] },
  ],
  journeys: [
    {
      leadId: 'lead-14',
    ...
    },
    {
      leadId: 'lead-10',
      lead: 'Sarah Pearse',
      stage: 'Instruction handoff rescue',
      value: 1300,
      agent: 'Jonny Green',
      steps: [
        { label: 'Quote accepted', at: '15 Jun', status: 'done', note: 'Instruction intent is confirmed.' },
        { label: 'Pack opened', at: 'Today', status: 'done', note: 'Warm handoff signal.' },
        { label: 'AI drafted rescue', at: 'Now', status: 'current', note: 'Help with missing instruction step before legal owner takes over.' },
      ],
    },
  ],
  outreachDrafts: [
    ...
    { key: 'draft-handoff', leadId: 'lead-10', lead: 'Sarah Pearse', channel: 'email', campaign: 'Instruction handoff rescue', variant: 'Pack completion helper', tone: 'warm', risk: 'low', expectedReplyRate: 31, approvalStatus: 'running', subject: 'Need help finishing the instruction pack?', body: 'You are nearly at instruction handoff. Do you want me to resend the pack or help with the missing step?', guardrails: ['one follow-up maximum', 'no sales pressure', 'handoff-only language'], value: 1300 },
  ...
  agentPerformance: [
    ...
    { agent: 'Jonny Green', recovered: 9, value: 21800, approvalRate: 87, handoverMins: 24, missed: 3, bestCohort: 'Instruction handoff', trend: [3, 4, 5, 6, 7, 9] },
  ...
  lifecycle: [
    ...
    { key: 'handoff-rescue-growth', label: 'Instruction handoff rescue', stage: 'Pre-Instruction Growth', count: 54, value: 29800, conversionRate: 9.1, owner: 'Jonny Green', nextAction: 'Close accepted-not-instructed gaps', tone: 'good' },
  ...
  dormantVault: [
    ...
    { leadId: 'lead-h41', lead: 'History Lead 42', bucket: 'Accepted stale', ageDays: 32, value: 960, source: 'Direct', location: 'Bristol', score: 68, lastSignal: 'Instruction pack unopened', risk: 'low', nextAction: 'Resend pack and confirm handoff', agent: 'Louise Forshaw' },
  ],
  advice: [
    ...
    { severity: 'med', title: 'Keep post-instruction out of Connor queue', text: 'Accepted-not-instructed leads have a 31% reply rate. Connor should rescue the handoff, then legal/client-care owners take over.' },
...
const FORECAST = {
  ...
  bridge: [
    { label: 'Leads expected', current: 222, forecast: 240, conversion: 100, risk: 'low', note: 'Seasonal uplift and stronger comparison-site intent.' },
    { label: 'Quotes likely', current: 143, forecast: 162, conversion: 68, risk: 'low', note: 'Quote engine demand rises with sale + purchase enquiries.' },
    { label: 'Instructions forecast', current: 52, forecast: 58, conversion: 36, risk: 'medium', note: 'Instruction lift depends on speed-to-lead and quote follow-up.' },
    { label: 'Completions forecast', current: 14, forecast: 16, conversion: 28, risk: 'medium', note: 'Completions are constrained by enquiry and mortgage-offer stages.' },
    { label: 'Revenue forecast', current: 68000, forecast: 74000, conversion: 100, risk: 'low', note: 'Average fee improves where sale + purchase mix is higher.' },
  ],
  regions: [
    { key: 'north-west', label: 'North West', area: 'Manchester / Liverpool', x: 47, y: 48, leads: 39, forecastLeads: 46, forecastInstructions: 12, capacity: 10, conversion: 26, avgFee: 1280, topSource: 'Comparison site', marketSignal: 'High quote reopen + remortgage interest', confidence: 84, action: 'Pre-book 2 extra quote follow-up slots.' },
    { key: 'midlands', label: 'Midlands', area: 'Birmingham / Nottingham', x: 54, y: 61, leads: 44, forecastLeads: 50, forecastInstructions: 13, capacity: 11, conversion: 26, avgFee: 1240, topSource: 'Web form', marketSignal: 'Sale + purchase chains lifting', confidence: 81, action: 'Route higher-value chains to Louise.' },
    { key: 'london', label: 'London', area: 'London / Croydon', x: 64, y: 82, leads: 35, forecastLeads: 37, forecastInstructions: 8, capacity: 9, conversion: 22, avgFee: 1460, topSource: 'Direct', marketSignal: 'More cautious buyers, higher fee potential', confidence: 76, action: 'Use value framing, not volume chasing.' },
    { key: 'south-east', label: 'South East', area: 'Kent / Surrey / Sussex', x: 62, y: 87, leads: 31, forecastLeads: 36, forecastInstructions: 9, capacity: 8, conversion: 25, avgFee: 1380, topSource: 'Referral', marketSignal: 'Family movers and school-timing enquiries', confidence: 79, action: 'Protect afternoon callback coverage.' },
    { key: 'south-west', label: 'South West', area: 'Bristol / Exeter', x: 39, y: 86, leads: 23, forecastLeads: 27, forecastInstructions: 6, capacity: 7, conversion: 22, avgFee: 1190, topSource: 'Comparison site', marketSignal: 'Steady but price-sensitive', confidence: 73, action: 'Send cost-breakdown quote templates.' },
    { key: 'yorkshire', label: 'Yorkshire', area: 'Leeds / Sheffield', x: 57, y: 51, leads: 27, forecastLeads: 32, forecastInstructions: 8, capacity: 6, conversion: 25, avgFee: 1220, topSource: 'Phone', marketSignal: 'Hot call intent rising', confidence: 78, action: 'Add morning call capacity.' },
    { key: 'east', label: 'East', area: 'Cambridge / Norwich', x: 66, y: 70, leads: 18, forecastLeads: 21, forecastInstructions: 5, capacity: 6, conversion: 24, avgFee: 1310, topSource: 'Web form', marketSignal: 'Purchase-heavy but slower decisions', confidence: 70, action: 'Watch quote expiry windows.' },
    { key: 'wales', label: 'Wales', area: 'Cardiff / Swansea', x: 35, y: 72, leads: 15, forecastLeads: 18, forecastInstructions: 4, capacity: 5, conversion: 22, avgFee: 1130, topSource: 'Comparison site', marketSignal: 'Low volume, good remortgage pockets', confidence: 68, action: 'Keep email-first nurture.' },
  ],
  sources: [
    { source: 'Comparison site', currentLeads: 96, forecastLeads: 110, expectedInstructions: 23, conversion: 21, costPerInstruction: 142, confidence: 82, action: 'Keep budget but split by region and speed-to-lead.' },
    { source: 'Web form', currentLeads: 54, forecastLeads: 61, expectedInstructions: 16, conversion: 26, costPerInstruction: 0, confidence: 86, action: 'Prioritise immediate quotes; best quality source.' },
    { source: 'Phone', currentLeads: 38, forecastLeads: 43, expectedInstructions: 12, conversion: 28, costPerInstruction: 28, confidence: 79, action: 'Add morning cover where pickup is strongest.' },
    { source: 'Referral', currentLeads: 22, forecastLeads: 25, expectedInstructions: 7, conversion: 29, costPerInstruction: 0, confidence: 74, action: 'Connect to won-client referral campaign.' },
    { source: 'Direct', currentLeads: 12, forecastLeads: 14, expectedInstructions: 4, conversion: 27, costPerInstruction: 0, confidence: 71, action: 'Use premium value copy and fast callbacks.' },
  ],
  capacity: [
    { team: 'Quote follow-up', owner: 'Louise Forshaw', currentCases: 84, forecastCases: 103, capacity: 92, risk: 'high', action: 'Move 11 quote-rescue tasks or add temporary cover.' },
    { team: 'New lead calls', owner: 'Jonny Green', currentCases: 71, forecastCases: 82, capacity: 88, risk: 'low', action: 'Use spare call slots for Yorkshire and North West demand.' },
    { team: 'Instruction onboarding', owner: 'Helen Sadler', currentCases: 49, forecastCases: 58, capacity: 54, risk: 'medium', action: 'Pre-book onboarding review time before July uplift lands.' },
    { team: 'Mortgage-offer chase', owner: 'Dej A', currentCases: 37, forecastCases: 45, capacity: 42, risk: 'medium', action: 'Start proactive lender-chase tasks for high-value files.' },
  ],
  externalSignals: [
    { label: 'HMRC transactions', value: 'monthly official transactions', source: 'HMRC', impact: 'Use as market-volume baseline against APCM lead inflow.', action: 'Compare regional demand against national completion trend.', tone: 'info' },
    { label: 'UK House Price Index', value: 'April 2026 latest', source: 'UK HPI', impact: 'Regional price movement helps explain buyer urgency and fee mix.', action: 'Weight London/South East value separately from volume.', tone: 'warn' },
    { label: 'Price Paid Data', value: 'actual sold prices', source: 'HM Land Registry', impact: 'Can enrich regional average fee and transaction-type assumptions.', action: 'Later: use postcode/region sold-price bands in forecasts.', tone: 'good' },
    { label: 'Process reform', value: 'upfront packs + digital data', source: 'Market reform', impact: 'If reforms shorten timelines, completion forecast should react.', action: 'Track enquiry-to-completion days by region and lender.', tone: 'info' },
  ],
  scenarios: [
    { label: 'Base forecast', leadDelta: 8, instructions: 58, revenue: 74000, completionRisk: 18, capacityGap: 11, note: 'Current lead growth with known summer uplift.' },
    { label: 'Capacity protected', leadDelta: 8, instructions: 63, revenue: 81000, completionRisk: 13, capacityGap: 0, note: 'Move quote follow-up tasks and add onboarding cover.' },
    { label: 'Market slows', leadDelta: -6, instructions: 49, revenue: 63000, completionRisk: 24, capacityGap: -8, note: 'Buyer demand softens; focus on recovery and referrals.' },
  ],
  matterMix: [
    { type: 'Sale + Purchase', forecastLeads: 72, expectedInstructions: 21, avgFee: 1640, capacityRisk: 'high' },
    { type: 'Purchase', forecastLeads: 68, expectedInstructions: 16, avgFee: 1260, capacityRisk: 'medium' },
    { type: 'Sale', forecastLeads: 54, expectedInstructions: 12, avgFee: 1180, capacityRisk: 'medium' },
    { type: 'Remortgage', forecastLeads: 46, expectedInstructions: 9, avgFee: 780, capacityRisk: 'low' },
  ],
  actions: [
    { title: 'Protect quote follow-up capacity', detail: 'Forecast shows 103 quote follow-up cases against 92 capacity. Move work before July demand lands.', href: '/capacity', priority: 'high' },
    { title: 'Route regional demand by pressure', detail: 'North West, Midlands and Yorkshire forecast more instructions than current local capacity.', href: '/lead-management?view=by-region', priority: 'high' },
    { title: 'Use lead source forecast for spend', detail: 'Comparison site volume rises, but web form and phone convert better. Do not chase volume blindly.', href: '/marketing', priority: 'medium' },
    { title: 'Add forecast to recovery planning', detail: 'If market slows, second-chance revenue becomes the buffer for instruction targets.', href: '/second-chance-revenue', priority: 'medium' },
  ],
