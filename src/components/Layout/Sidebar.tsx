  ...
  const navigationGroups: NavigationGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Lifecycle Growth', href: '/lifecycle-growth', icon: Rocket, roles: ['Admin', 'Manager'] },
        ...
        { name: 'Second-Chance Revenue', href: '/second-chance-revenue', icon: Coins, roles: ['Admin', 'Manager'] },
