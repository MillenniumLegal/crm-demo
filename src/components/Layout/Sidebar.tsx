...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onToggle }) => {
  ...
  const navigationGroups: NavigationGroup[] = [
    ...
    },
    {
      label: 'Legal Handoff',
      items: [
        { name: 'Post-Instruction Matters', href: '/matter-progression', icon: Milestone, roles: ['Admin', 'Manager'] },
        { name: 'Legal Compliance', href: '/compliance', icon: ShieldAlert, roles: ['Admin', 'Manager'] },
        { name: 'Legal Ops Health', href: '/ops-health', icon: Gauge, roles: ['Admin', 'Manager'] },
      ],
    },
    {
      label: 'Growth',
      items: [
        ...
        { name: 'Pre-Instruction Growth', href: '/lifecycle-growth', icon: Rocket, roles: ['Admin', 'Manager'] },
        { name: 'Contact Intelligence', href: '/contact-intelligence', icon: Search, roles: ['Admin', 'Manager'] },
        { name: 'AI Outreach Command', href: '/ai-outreach-command', icon: Brain, roles: ['Admin', 'Manager'] },
        { name: 'Dormant Lead Vault', href: '/dormant-lead-vault', icon: Clock, roles: ['Admin', 'Manager'] },
        { name: 'Second-Chance Instruction', href: '/second-chance-revenue', icon: Coins, roles: ['Admin', 'Manager'] },
